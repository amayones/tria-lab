...
export const WEBSITES = [
  ...
  {
    code: "TRIA-003",
    name: "BangunJaya — Company Profile Pro",
    category: "Company Profile",
    price: 2199000,
    description:
      "Company profile modern untuk kontraktor & jasa konstruksi — BangunJaya — hero terpercaya, statistik proyek, layanan pembangunan & renovasi, portfolio proyek, keunggulan, testimoni klien, dan CTA konsultasi WhatsApp langsung.",
    tags: ["React", "Vite", "Tailwind", "Responsive", "Company Profile"],
    demoUrl: "https://comprof-blond.vercel.app/",
    preview: "assets/img/previews-catalog/comprof-desktop.png",
    previews: {
      desktop: "assets/img/previews-catalog/comprof-desktop.png",
      tablet: "assets/img/previews-catalog/comprof-tablet.png",
      mobile: "assets/img/previews-catalog/comprof-mobile.png",
    },
    features: [
      "React Vanilla + Vite + Tailwind CSS (tanpa meta-framework, build cepat & ringan)",
      "Fully Responsive — Desktop, Tablet & Mobile (layout adaptif)",
      "Hero Section — Headline kontraktor terpercaya + Statistik Proyek & CTA Konsultasi",
      "Section Layanan — Pembangunan, Renovasi, Infrastruktur & Desain Perencanaan",
      "Portfolio / Project Showcase — Galeri proyek dengan filter kategori",
      "Section Tentang — Profil Perusahaan, Visi Misi & Keunggulan Kompetitif",
      "Team Section & Testimoni Klien untuk kepercayaan brand",
      "Contact Form + Integrasi WhatsApp & Google Maps Lokasi Kantor",
      "SEO Ready & Performance Optimized (Vite build + semantic HTML)",
    ],
    included: [
      "Website sesuai desain",
      "Responsive layout",
    ...
    suitedFor: ["Kontraktor", "Jasa Konstruksi", "Developer Properti", "Perusahaan Jasa"],
  },
  {
   code: "TRIA-004",
  name: "Rumah Hati",
